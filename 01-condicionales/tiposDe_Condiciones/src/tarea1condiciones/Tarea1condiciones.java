...
se hace un descuento sobre el valor de la compra total segun el
color de la ficha que el cliente saque de una urna oscura.
se sabe que si el color de la ficha es rojo el cliente obtendra un
100% de un descuento; si es amarillo un 75%
 */
package tarea1condiciones;
 ...
 */
public class Tarea1condiciones {
